...
class ALDBotLoggerMeaure(Measurement):
    ...
    def run(self):
        ...
        while not self.interrupt_measurement_called:
            ...
            for ch in ['ch2_pressure', 'ch3_pressure']:
            ...
            chamber_gauge = self.app.hardware['Pfeiffer_Chamber_Gauge']
            dat_chamber = chamber_gauge.settings.gauge1_pressure_scaled.read_from_hardware()
            self.gauge_plotdata['ch1_pressure_scaled'].append(dat_chamber)
